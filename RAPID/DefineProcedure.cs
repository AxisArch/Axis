...
namespace Axis.RAPID
{
    public class DefineProcedure : GH_Component
    {
        ...
        public DefineProcedure() : base("Define Procedure", "Define Procedure", "Creates a custom RAPID procedure", "Axis", "RAPID")
        {
        }
        ...
        {
            pManager.AddTextParameter("Procedure", "Procedure", "Custom RAPID-formatted procedure.", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData(0, ref procName))
            if (!DA.GetData(1, ref procVariable))
            if (!DA.GetDataList(2, strCommands))
