...
{
    public class ProgramParam : GH_PersistentParam<IGH_Goo>
    {
        public override GH_Exposure Exposure => GH_Exposure.hidden; // <--- Make it hidden when it is working.

        public ProgramParam()
          : base("Robot Instructions", "Instructions", "Axis robot instruction set type.", Axis.AxisInfo.Plugin, Axis.AxisInfo.TabParam)
        { }

        public override Guid ComponentGuid => new Guid("0A49815D-C6B9-4D2E-8719-A4EE118E803E");
