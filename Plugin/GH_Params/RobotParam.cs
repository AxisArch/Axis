...
{
    public class RobotParam : GH_PersistentParam<Robot>
    {
        ...
        protected override Robot InstantiateT()
        {
            return Abb6DOFRobot.Default;
        }

        protected override GH_GetterResult Prompt_Singular(ref Robot value)
        {
        ...
        protected override GH_GetterResult Prompt_Plural(ref List<Robot> values)
        {
            return GH_GetterResult.cancel;
        }
